...
So go ahead and make that happen. You'll need to use this code for the rest of the
exercises.

Cryptopals Rule
Always operate on raw bytes, never on encoded strings. Only use hex and base64 for
pretty-printing.
"""
...
def test_hex_to_base64_example():
    input_hex = (
        '49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f757'
        '3206d757368726f6f6d'
    )
